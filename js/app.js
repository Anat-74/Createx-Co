(() => {
    ...
    function initSliders() {
        if (true) {
            ...
            bodyStyles.getPropertyValue("--hero-slider-speed");
            document.body.style.setProperty("--hero-slider-speed", heroSliderSpeed + "ms");
            new core(".hero__slider-home", {
        ...
        if (true) {
            const heroSliderNav = new core(".hero-slider-nav", {
                slidesPerView: 10,
                spaceBetween: 20,
                freeMode: true,
                watchSlidesProgress: true
        ...
        //!==========================================================================================
            ...
            const historySlider = new core(".history__slider", {
                modules: [ Navigation ],
                loop: true,
                slidesPerView: 1,
                spaceBetween: 15,
    ...
    if (rowIcons) rowIcons.addEventListener("click", (e => {
    ...
    const isVisibleToTop = (y = 0) => {
        if (y >= heroHeight) toTop.classList.add("to-top--visible"); else toTop.classList.remove("to-top--visible");
    };
